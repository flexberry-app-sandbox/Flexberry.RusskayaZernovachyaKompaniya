...
moduleForModel('i-i-s-russkaya-zernovachya-kompaniya-накладная', 'Unit | Serializer | i-i-s-russkaya-zernovachya-kompaniya-накладная', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-russkaya-zernovachya-kompaniya-накладная',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
