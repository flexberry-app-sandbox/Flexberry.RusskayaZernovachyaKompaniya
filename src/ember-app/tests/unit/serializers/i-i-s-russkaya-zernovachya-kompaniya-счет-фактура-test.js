...
moduleForModel('i-i-s-russkaya-zernovachya-kompaniya-счет-фактура', 'Unit | Serializer | i-i-s-russkaya-zernovachya-kompaniya-счет-фактура', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-russkaya-zernovachya-kompaniya-счет-фактура',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
