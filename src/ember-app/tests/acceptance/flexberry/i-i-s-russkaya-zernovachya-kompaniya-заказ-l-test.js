...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya заказ l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-заказ-l', function(assert) {
