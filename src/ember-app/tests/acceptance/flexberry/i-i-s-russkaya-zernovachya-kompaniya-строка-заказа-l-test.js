...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya строка заказа l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-строка-заказа-l', function(assert) {
