...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya контрагент l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-контрагент-l', function(assert) {
