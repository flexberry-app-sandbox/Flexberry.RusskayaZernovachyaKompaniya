...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya цена товара l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-цена-товара-l', function(assert) {
