...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya накладная l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-накладная-l', function(assert) {
