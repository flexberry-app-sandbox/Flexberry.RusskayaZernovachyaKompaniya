...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya т ч сч фактуры l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-т-ч-сч-фактуры-l', function(assert) {
