...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya товар l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-товар-l', function(assert) {
