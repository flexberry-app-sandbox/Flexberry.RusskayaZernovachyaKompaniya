...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya склад l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-склад-l', function(assert) {
