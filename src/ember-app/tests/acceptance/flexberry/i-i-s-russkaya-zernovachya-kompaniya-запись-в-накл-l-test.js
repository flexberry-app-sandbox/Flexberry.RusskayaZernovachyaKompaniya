...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya запись в накл l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-запись-в-накл-l', function(assert) {
