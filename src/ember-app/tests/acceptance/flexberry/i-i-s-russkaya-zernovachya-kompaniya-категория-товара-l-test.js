...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya категория товара l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-категория-товара-l', function(assert) {
