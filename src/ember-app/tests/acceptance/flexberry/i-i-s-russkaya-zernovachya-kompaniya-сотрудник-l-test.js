...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya сотрудник l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-сотрудник-l', function(assert) {
