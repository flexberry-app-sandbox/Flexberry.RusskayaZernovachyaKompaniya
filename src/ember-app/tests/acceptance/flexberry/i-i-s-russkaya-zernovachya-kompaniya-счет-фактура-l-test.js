...
moduleForAcceptance('[AGAT] Acceptance | i i s russkaya zernovachya kompaniya счет фактура l');

test('testing i-i-s-russkaya-zernovachya-kompaniya-счет-фактура-l', function(assert) {
